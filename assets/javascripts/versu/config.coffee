versu.config =
  ...
  paths:
    getAssetsPath: ->
      "assets" + versu.constants.urlDelimiter

    getImagesPath: ->
      versu.config.paths.getAssetsPath() + "images" + versu.constants.urlDelimiter

    getCharacterImagesPath: ->
      versu.config.paths.getImagesPath() + "characters" + versu.constants.urlDelimiter

    getJavascriptsPath: ->
      versu.config.paths.getAssetsPath() + "javascripts" + versu.constants.urlDelimiter

    getStylesheetsPath: ->
      versu.config.paths.getAssetsPath() + "stylesheets" + versu.constants.urlDelimiter
